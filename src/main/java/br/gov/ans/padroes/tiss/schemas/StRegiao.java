...
/**
 * <p>Classe Java de st_regiao.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * <p>
 * <pre>
 * &lt;simpleType name="st_regiao">
 ...
 * 
 */
@XmlType(name = "st_regiao")
@XmlEnum
public enum StRegiao {
    ...
    public static StRegiao fromValue(String v) {
        for (StRegiao c: StRegiao.values()) {
            if (c.value.equals(v)) {
                return c;
            }
        }
